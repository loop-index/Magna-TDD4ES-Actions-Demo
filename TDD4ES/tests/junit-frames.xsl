...
h2 {
    margin-top: 1em; margin-bottom: 0.5em; font: bold 180% verdana,arial,helvetica
}
h3 {
    margin-bottom: 0.5em; font: bold 160% verdana,arial,helvetica
}
h4 {
    margin-bottom: 0.5em; font: bold 140% verdana,arial,helvetica
}
h5 {
    margin-bottom: 0.5em; font: bold 120S% verdana,arial,helvetica
}
h6 {
...
<xsl:template match="testsuite" mode="class.details">
    ...
    <html>
       ...
       <script type="text/javascript" language="JavaScript"><![CDATA[
        ...
        <body>
            <xsl:call-template name="pageHeader"/>
            <h3>Test Group <xsl:value-of select="$class.name"/></h3>
...
<xsl:template match="testsuites" mode="all.packages">
    <html>
        ...
        <body>
            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/6/63/Magna_logo.svg/1200px-Magna_logo.svg.png" height="40" />
            <h1><b>Testing Report</b></h1>
            <h2><a href="overview-summary.html" target="classFrame">Summary</a></h2>
            <h2>Packages</h2>
            <table width="100%">
    ...
    <tr>
        <td nowrap="nowrap">
            <a href="./{translate(@package,'.','/')}/package-summary.html" target="classFrame">
                ...
                <xsl:if test="@package = ''">Demo</xsl:if>
            </a>
        </td>
    </tr>
</xsl:template>
